...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#t1").css("color","green"); // 아이디 속성 
		$(".t2").css("color","yellow"); // 클래스 속성 
...
// 		$("input[type=password]").css("color","blue");
		$("input[type^=p]").css("color","blue");  // ^=p 는 p로 시작하는이라는 뜻
		$("tr:first").css("background","yellow");
		
		//홀수
		$("tr:odd").css("background","green");                  // 인덱스 순서를 찾아감 0부터
		
		//짝수
		$("tr:even").css("background","blue");					// 인덱스 순서를 찾아감
